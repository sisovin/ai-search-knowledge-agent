    ...
    <footer className="bg-card border-t mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-lg">AI Knowledge Agent</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Advanced AI-powered search and knowledge management tool
            </p>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/documents" className="text-sm hover:text-primary transition-colors">
                  Documents
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between">
          <div className="text-sm text-muted-foreground order-2 sm:order-1 mt-4 sm:mt-0">
            © {currentYear} AI Knowledge Agent. All rights reserved.
          </div>
        ...
        {/* Language selector could go here in the future */}
      </div>
    </footer>
  );
}
